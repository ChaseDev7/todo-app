    ...
    project.addEventListener("click", function showTodosFromProject () {
      ...
      const showTodosList = () => {
        ...
        for (let i = 0; i < selectedProject.length; i++) {
          ...
          newDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(newDueDate), 'PP');
